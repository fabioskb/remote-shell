...
public class RcmdColor {
	...
	public Color pegarCor(boolean noite, int indiceCor) {
        ...
        /**
         * Retorna uma cor (Color) de acordo com o indice da cor.
         * @param indiceCor - [0] Banner BG e Descrição Borda, [1] Banner FG, [2] lblResultado BG,
	 * [3] Padrão BG, [4] Descrição BG, [5] Botões BG, [6] FG botões e descrição, [7] Erros, [8] Avisos,
	 * [9] Concluído com sucesso, [10] Área de texto (link, pesquisa e lista).
	 * @return Retorna uma cor de cores[].
         * @return (Color) cor
         */
	public Color pegarCor(int indiceCor) {
