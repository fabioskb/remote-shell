...
public class RemoteShellScreen extends JFrame {
    ...
    public JPanel getPanelWest() {
        if (panelWest == null) {
            ...
            toggleButtonSaveMode.setToolTipText(TEXT.pegarTexto(22));
    ...
    public JPanel getPanelCenter() {
        if (panelCenter == null) {
            ...
            textFieldUser.setToolTipText(TEXT.pegarTexto(23));
            textFieldEmail.setToolTipText(TEXT.pegarTexto(24));
            textFieldWaitTime.setToolTipText(TEXT.pegarTexto(25));
    ...
    public JPanel getPanelSouth() {
        if (panelSouth == null) {
            ...
            buttonExecute.setToolTipText(TEXT.pegarTexto(26));
            buttonSetting.setToolTipText(TEXT.pegarTexto(27));
            buttonReset.setToolTipText(TEXT.pegarTexto(28));
            buttonStop.setToolTipText(TEXT.pegarTexto(29));
            buttonExit.setToolTipText(TEXT.pegarTexto(30));
